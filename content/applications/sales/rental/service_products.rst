...
.. note::
   If a rental product is added *before* the :guilabel:`Rental period` field has been
...
.. tip::
   Project templates allow for automated task assignment. When integrated with the **Planning**
