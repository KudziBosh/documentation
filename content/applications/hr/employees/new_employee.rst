...
This tab is visible for all employees, and does not require any other apps to be installed for
this to be visible.
...
- :guilabel:`Job Title`: This field is automatically popoulated with the selection made in the
  ...
  .. example::
     ...
     :guilabel:`Sales Representative` in the **Recruitment** app, that can be selected for the
     :guilabel:`Job Position` field.

     In the typed-in :guilabel:`Job Title` can be more specific, such as `Sales Representative -
...
Days left blank indicate the employee does not work on that day.
...
- :guilabel:`Type`: Click the corresponding button to reflect the *type* of experience being added.
  The available options are:guilabel:`Other Experience`, :guilabel:`Education`, :guilabel:`Training`,
  or :guilabel:`Internal Certification`.
...
- :guilabel:`Duration`: Enter the start and end dates for the work experience using the calendar
  module.
- :guilabel:`Certificate`: If there is a relevant certificate to attach, click the
  :guilabel:`Upload your file` button, select the desired file, and click :guilabel:`Select`. The
  file name appears in the field, not an image of the certificate.
...
- :guilabel:`Color`: Click on the existing color to viw the available colors. Click the desired
  color to select it
- :guilabel:`Certification`: Click the toggle to indicate the skill is a certification. The toggle
  turns green, indicating it is active.
...
- :guilabel:`Bank Accounts`: Enter the bank account number for the employee, and click
  :guilabel:`Create and edit..`. A *Create Bank Accounts* pop-up window loads with the bank account
  number populating the :guilabel:`Account Number` field. Next, enter the :guilabel:`Clearing
  Number` (also referred ot as a *routing number*) in the corresponding field.
  ...
  the drop-down menu. This bak acts as a facilitator between banks fo rinternational wire transfers,
  when needed. Enter the :guilabel:`Bank Address`, :guilabel:`Phone`, and :guilabel:`Email` in the
  corresponding fields. Once the form is complete, click :guilabel:`Save`, and the new bank
  ...
  The :guilabel:`Employee` field is populated with the employee's name, and cnanot be modified.
...
- :guilabel:`Phone`: Enter the emergency contact's phone number. It is recommended to enter
...
IDifferent fields may be visible, depending on the localization installed.
...
- :guilabel:`SIM Card Copy`: Upload a copy of the SIM card if the employee isusing a work-issued
  mobile phone.
- :guilabel:`Internet Subscription Invoice`: If the employee is receiving beneifts or compensation
...
- :guilabel:`Work Permt No`: Enter the employee's work permit number. When entered, an
...
- :guilabel:`Home-Work Distance`: Enter the distance from the employee's home to their work
  location in the first field. Set the second field to either kilometers (:guilabel:`km`) or miles
  (:guilabel:`mi`) using the drop-down menu.
...
:doc:`contracts <../payroll/contracts>` document for detailed infomration on creating and modifying
employee contracts.
...
- :guilabel:`Wage on Signature`: This field.......................................................
............................................................
...
- :guilabel:`Work Entry Source`: Determine how the employee's work entries are created in the
  **Payroll** app using the drop-down menu. :guilabel:`Working Schedukes` is selected by default. If
...
- :guilabel:`Timesheet`: Slect the user responsible for approving all the employee's timesheet
...
- :guilabel:`Hourly Cost`: Enter the hourly cost for the employee, in a `##.##`` format. This cost
...
- :guilabel:`RFID/Badge Number`: Click :guilabel:`Generate` at the end of the :guilabel:`RFID/Badge
  ...
  the number popiulates the :guilabel:`RFID/Badge Number` field.
- :guilabel:`Overtime Ruleset`: Select the :doc:`overtime rules <employees/overtime>` to be used
  when calculating overtime for the employee using the drop-down menu.
...
MOVE THIS TAG WHERE IT NEEDS TO GO!
